...
local tkhome = vim.fn.expand("~/writing")
require('telekasten').setup {
    ...
    dailies      = tkhome .. '/' .. 'daily',
    weeklies     = tkhome .. '/' .. 'weekly',
    ...
    -- set to `nil` or do not specify if you do not want a template
    template_new_daily = tkhome .. '/' .. 'templates/daily.md',

    -- template for newly created weekly notes (goto_thisweek)
    -- set to `nil` or do not specify if you do not want a template
    template_new_weekly = tkhome .. '/' .. 'templates/weekly.md',
